                ...
                <div className="relative">
                  ...
                  >
                    {showPassword ? (
                      ...
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-1.473-1.473A10.014 10.014 0 0019.542 10C18.268 5.943 14.478 3 10 3a9.958 9.958 0 00-4.512 1.111l-1.781-1.818zM10 5a3.973 3.973 0 00-3.255 1.688A3.972 3.972 0 005 10a4 4 0 007.8 1.231l-1.613-1.613a2 2 0 00-2.995-2.988L10 5zm5.466 4.488a4 4 0 01-7.364 2.005L7.217 10.5A2 2 0 0010 8.5l5.466.5z" clipRule="evenodd" />
                      </svg>
                    )}
                  </button>
                </div>
